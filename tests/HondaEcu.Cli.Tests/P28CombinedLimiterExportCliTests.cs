...
public sealed class P28CombinedLimiterExportCliTests
{
    private static string[] Args(P28AcquisitionCliTests.Workspace w, string operation)
    {
        ...
        File.WriteAllText(settings, """{"formatVersion":1,"purpose":"explicit-limiter-group-selection","fixed":{"cutRaw":900,"resumeRaw":920},"bank0":null,"bank1":null}""");
        var common = new[] { "research", "p28-limiter", "combined-export", operation, w.Baseline, "--profile", "p28-304", "--baseline-binding", w.Binding,
